...
RSpec.describe Operations::Reports::Reject do
  ...
  describe "#call" do
    ...
    context "with an already rejected report" do
      let!(:report) do
      ...
      it "returns Failure with invalid_status error" do
        ...
        expect(result.failure.last).to include("must be pending_review to reject")
      end
    ...
    context "rejecting multiple reports" do
      let!(:report1) do
        create(:report, :pending_review,
               race: race,
               user: user,
