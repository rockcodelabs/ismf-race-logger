...
# ============================================================================
#
# Official ISMF penalty codes and their corresponding sanctions
# Source: ISMF Competition Rules
#
# Categories:
# - A: General infringements not specifically cited
# - B: Equipment
# - C: Behaviour
# - D: Team race specific
# - E: Relay race specific
# - F: Coaches and officials
#
# ============================================================================

puts "\nLoading ISMF penalties..."
