...
if sprint
  ...
  sprint_locations = [
    { name: "Start", course_segment: "start_area", segment_position: "full", display_order: 10, is_standard: true, color_code: nil, description: "Race start area" },
    ...
    { name: "Transition 1→2", course_segment: "transition_1to2", segment_position: "full", display_order: 50, is_standard: true, color_code: nil, description: "Transition area between climbs" },
    ...
    { name: "Transition 2→1", course_segment: "transition_2to1", segment_position: "full", display_order: 80, is_standard: true, color_code: nil, description: "Transition to descent" },
    ...
    { name: "Finish", course_segment: "finish_area", segment_position: "full", display_order: 130, is_standard: true, color_code: nil, description: "Race finish line" }
  ]
...
if individual
  ...
  individual_locations = [
    ...
    { name: "Transition 1→2", course_segment: "transition_1to2", segment_position: "full", display_order: 50, is_standard: true, color_code: nil, description: "First transition area" },
    { name: "Uphill 2 - Start", course_segment: "uphill2", segment_position: "start", display_order: 60, is_standard: true, color_code: "green", description: "Beginning of second uphill" },
    ...
    { name: "Transition 2→1", course_segment: "transition_2to1", segment_position: "full", display_order: 90, is_standard: true, color_code: nil, description: "Second transition area" },
...
if vertical
  ...
  vertical_locations = [
    ...
    { name: "Finish", course_segment: "finish_area", segment_position: "full", display_order: 70, is_standard: true, color_code: nil, description: "Race finish line" }
  ]
...
if team
  ...
  team_locations = [
    ...
    { name: "Transition", course_segment: "transition_1to2", segment_position: "full", display_order: 50, is_standard: true, color_code: nil, description: "Transition area" },
    ...
    { name: "Finish", course_segment: "finish_area", segment_position: "full", display_order: 80, is_standard: true, color_code: nil, description: "Race finish line" }
  ]
...
if mixed_relay
  ...
  mixed_relay_locations = [
    ...
    { name: "Descent - Start", course_segment: "descent", segment_position: "start", display_order: 60, is_standard: true, color_code: "red", description: "Top of descent" },
    { name: "Descent - Middle", course_segment: "descent", segment_position: "middle", display_order: 70, is_standard: true, color_code: "red", description: "Mid-point of descent" },
    { name: "Handoff Zone", course_segment: "finish_area", segment_position: "start", display_order: 80, is_standard: true, color_code: nil, description: "Relay handoff zone" },
    { name: "Finish", course_segment: "finish_area", segment_position: "full", display_order: 90, is_standard: true, color_code: nil, description: "Race finish line" }
  ]
